...
}`,...l.parameters?.docs?.source},description:{story:"## Mouse event control\nDemonstration of `isDisabledMouseEvent` property.\nWhen enabled, dragging is disabled, only keyboard input remains.",...l.parameters?.docs?.description}}};const v=["Default","WithAlpha","DisabledState","MouseEventControl"];export{s as Default,n as DisabledState,l as MouseEventControl,o as WithAlpha,v as __namedExportsOrder,C as default};
