...
import { removeTrailingZeros } from '../../hooks/remove-trailing-zeros';
...
export const InputNumberSelect = React.forwardRef<HTMLInputElement, InputNumberSelectProps>(
    (
        {
            min,
            max,
...
InputNumberSelect.displayName = 'InputSelectNumber';