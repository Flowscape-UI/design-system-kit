...
>(
	(
      ...
      `
		...
		const hexhexColor = tc(hexColor).toHex()
		const rgbahexColor = tc(hexhexColor).setAlpha(opacity).toRgbString()
		...
		const renderIcon = useMemo(() => {
			return (
				<div
					...
					style={{
						backgroundColor: rgbahexColor,
					}}
				/>
			)
		}, [rgbahexColor, classNamePreview])
