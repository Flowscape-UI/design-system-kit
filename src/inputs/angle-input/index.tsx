...
export type AngleInputProps = BaseInputPropsWithoutUnit

export const AngleInput = React.memo(
	React.forwardRef<HTMLInputElement, AngleInputProps>(
		(
			{
				value,
				onChange,
			...
			const renderIcon = useMemo(() => {
				...
				return <RotateCw size={16} className={themeClasses.icon} />
