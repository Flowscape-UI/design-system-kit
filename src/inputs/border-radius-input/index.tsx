...
export type BorderRadiusInputProps = BaseInputProps

export const BorderRadiusInput = React.memo(
	React.forwardRef<HTMLInputElement, BorderRadiusInputProps>(
		(
			{
				value,
				onChange,
			...
			const renderIcon = useMemo(() => {
				...
				return <Circle size={16} className={themeClasses.icon} />
...
BorderRadiusInput.displayName = 'BorderRadiusInput'
