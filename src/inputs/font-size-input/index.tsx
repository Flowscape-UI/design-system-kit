...
export type FontSizeInputProps = BaseInputProps

export const FontSizeInput = React.memo(
	React.forwardRef<HTMLInputElement, FontSizeInputProps>(
		(
			{
				value,
				onChange,
			...
			const renderIcon = useMemo(() => {
				...
				return <Type size={16} className={themeClasses.icon} />
