...
export type HeightInputProps = BaseInputProps

export const HeightInput = React.memo(
	React.forwardRef<HTMLInputElement, HeightInputProps>(
		(
			{
				value,
				onChange,
			...
			const renderIcon = useMemo(() => {
				...
				return <ArrowUpDown size={16} className={themeClasses.icon} />
