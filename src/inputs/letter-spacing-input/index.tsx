...
export type LetterSpacingInputProps = BaseInputProps

export const LetterSpacingInput = React.memo(
	React.forwardRef<HTMLInputElement, LetterSpacingInputProps>(
		(
			{
				value,
				onChange,
			...
			const renderIcon = useMemo(() => {
				...
				return <CaseSensitive size={16} className={themeClasses.icon} />
...
LetterSpacingInput.displayName = 'LetterSpacingInput'
