...
export type LineHeightInputProps = BaseInputPropsWithoutUnit

export const LineHeightInput = React.memo(
	React.forwardRef<HTMLInputElement, LineHeightInputProps>(
		(
			{
				value,
				onChange,
			...
			const renderIcon = useMemo(() => {
				...
				return (
					<AlignVerticalSpaceAround size={16} className={themeClasses.icon} />
				)
