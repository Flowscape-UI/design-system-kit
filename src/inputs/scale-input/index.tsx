...
export type ScaleInputProps = BaseInputPropsWithoutUnit

export const ScaleInput = React.memo(
	React.forwardRef<HTMLInputElement, ScaleInputProps>(
		(
			{
				value,
				onChange,
			...
			const renderIcon = useMemo(() => {
				...
				return <Maximize2 size={16} className={themeClasses.icon} />
