...
export type SpacingInputProps = BaseInputProps

export const SpacingInput = React.memo(
	React.forwardRef<HTMLInputElement, SpacingInputProps>(
		(
			{
				value,
				onChange,
			...
			const renderIcon = useMemo(() => {
				...
				return <Space size={16} className={themeClasses.icon} />
