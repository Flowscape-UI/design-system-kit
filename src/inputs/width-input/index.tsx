...
export type WidthInputProps = BaseInputProps

export const WidthInput = React.memo(
	React.forwardRef<HTMLInputElement, WidthInputProps>(
		(
			{
				value,
				onChange,
			...
			const renderIcon = useMemo(() => {
				...
				return <ArrowLeftRight size={16} className={themeClasses.icon} />
...
WidthInput.displayName = 'WidthInput'
