...
import {
	THEME_CLASSES,
	useNumberInput,
	type BaseInputPropsWithoutUnit,
} from '../shared'

export type ZIndexInputProps = BaseInputPropsWithoutUnit

export const ZIndexInput = React.memo(
	React.forwardRef<HTMLInputElement, ZIndexInputProps>(
		(
			{
				value,
				onChange,
			...
			const renderIcon = useMemo(() => {
				...
				return <Layers size={16} className={themeClasses.icon} />
...
ZIndexInput.displayName = 'ZIndexInput'
