  ...
  render: (args) => {
    ...
    return (
      <div style={{ padding: '20px', backgroundColor: '#f5f5f5' }}>
        <h3 style={{ fontSize: '18px', fontWeight: '600', marginBottom: '16px' }}>Basic Color Picker</h3>
        <ColorPicker
          {...args}
          value={color}
          onChange={setColor}
        />
        <div style={{ marginTop: '20px', padding: '12px', backgroundColor: 'white', borderRadius: '8px' }}>
...
export const Compact: Story = {
  ...
  render: (args) => {
    ...
    return (
      <div style={{ padding: '20px', backgroundColor: '#f5f5f5' }}>
        <h3 style={{ fontSize: '18px', fontWeight: '600', marginBottom: '16px' }}>Compact Size</h3>
        <ColorPicker
          {...args}
          value={color}
          onChange={setColor}
